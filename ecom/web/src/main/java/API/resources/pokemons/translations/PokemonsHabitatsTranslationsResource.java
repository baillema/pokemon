...
@Path("/pokemons-habitats-translations")
public class PokemonsHabitatsTranslationsResource extends Application {
    @EJB
    ...
    public Response getAll() {
        return Response.ok(dao.findWithNamedQuery(Requests.POK_HAB_TRANS_ALL))
                       .build();
    }
    ...
    public Response getAllFrench() {
        return Response.ok(dao.findWithNamedQuery(Requests.POK_HAB_TRANS_FR))
                       .build();
    }
    ...
    public Response getAllEnglish() {
        return Response.ok(dao.findWithNamedQuery(Requests.POK_HAB_TRANS_EN))
                       .build();
    }
    ...
    public Response getLang(@PathParam("species-id") int id, @PathParam("lang-id") int lang) {
        return Response.status(Response.Status.OK)
                       .entity(dao.findWithNamedQuery(Requests.POK_HAB_TRANS_FROM_ID_LANG, id, lang))
                       .build();
    }
}
